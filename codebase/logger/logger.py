...
class CustomLogger():
    ...
    def disableLogging(self):
        """disables logging levels from CRITICAL to below levels,
           basically turns off logging"""
        logging.disable(logging.CRITICAL)

    def reEnableLogging(self):
        """re-enables the disabeld logging and all the loggers are
           back to their original logging levels"""
